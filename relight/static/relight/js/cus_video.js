...
$(document).ready(function () {
    ...
    $("#chat-message-submit").click(function() {
        ...
        var html = '<div id="cus_message'+ cnt +'">' + name + ": " + message + '<button type="button" value="pin'+cnt+'" class="pin-btn-cus">ピン</button></div>';
        cus_cnt_set += 1;
...
function onRecvMessage(data) {
    ...
    var html = '<div id="shop_message'+ cnt +'">' + name + ": " + data + '<button type="button" value="pin'+cnt+'" class="pin-btn-shop">ピン</button></div>';
    shop_cnt_set += 1;
